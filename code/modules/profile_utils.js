...
async function getPersonalRecipesDetails(rid){
    ...
    instructions=await DButils.execQuery(`SELECT * FROM instructions WHERE recipe_id='${rid}'`);
    generalINFO=await DButils.execQuery(`SELECT * FROM personalRecipes WHERE recipe_id='${rid}'`);
    ingredients=await DButils.execQuery(`SELECT * FROM ingredients WHERE recipe_id='${rid}'`);
    
    console.log("id is: " +rid);
    // DButils.execQuery(`SELECT * FROM instructions WHERE recipe_id='${id}'`).then((instructions)=>{
    //     DButils.execQuery(`SELECT * FROM personalRecipes WHERE recipe_id='${id}'`).then ((generalINFO)=>{
    //         DButils.execQuery(`SELECT * FROM ingredients WHERE recipe_id='${id}'`).then((ingredients)=>{
    ...
    //             let ingredientsOfRec=ingredients.map((ing)=>{
    //                 console.log(ing);
    //                 var ingredientsOfRec={
    ...
    //                     "vegetarians": generalINFO.vegerarians,
    //                     "vegan": generalINFO.vagan,
    //                     "glutenFree": generalINFO.glutenFree,
